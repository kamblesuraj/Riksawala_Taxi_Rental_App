...
//        mapFragment.getMapAsync(this);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(Map_Customer.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
                            }
                        })
                        .create()
                        .show();
    ...
    private void GetSpeedAndAccuracy(Location location) {
        ...
        Toast.makeText(Map_Customer.this, "Accuracy is :" + Accuracy, Toast.LENGTH_SHORT).show();
        Toast.makeText(Map_Customer.this, "Speed is :" + speed, Toast.LENGTH_SHORT).show();
